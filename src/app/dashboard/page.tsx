...
export default function Dashboard() {
  ...
  const confirmDelete = async () => {
    ...
    setBookmarks(prev => prev.filter(b => b.id !== deleteConfirm.id))
    ...
    <div className="md:min-h-screen bg-slate-900">
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 max-w-md w-full p-6 transform transition-all">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white">Delete Bookmark</h3>
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition-colors duration-200 font-medium"
              >
                Cancel
              </button>
              <button
