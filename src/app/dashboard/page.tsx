                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      ...
                      className="opacity-0 md:group-hover:opacity-100 md:transition-opacity duration-200 p-2 bg-red-900/30 text-red-400 rounded-lg hover:bg-red-900/50 hover:text-red-300"
                    >
